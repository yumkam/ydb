...
def _load_default_yaml(default_tablet_node_ids, ydb_domain_name, static_erasure, log_configs):
    ...
    print("LOGLEVEL = " + os.getenv("YDB_DEFAULT_LOG_LEVEL", "NOTICE"), file=sys.stderr)
    data = data.format(
        ...
        ydb_default_log_level=int(LogLevels.from_string(os.getenv("YDB_DEFAULT_LOG_LEVEL", "DEBUG"))),
